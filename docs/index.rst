...
.. raw:: html
  ...
  margin-bottom: 10px; margin-top: 10px;">
    <div style="flex: 1; padding-right: 30px; display: flex; justify-content: center;">
      <img src="_static/images/feature-AD.png" alt="feature-AD" style="width: 60%; align-self: center;">
    </div>
  ...
  margin-bottom: 10px; margin-top: 10px;">
    <div style="flex: 1; padding-right: 30px; display: flex; justify-content: center;">
      <img src="_static/images/feature-gpu.png" alt="feature-AD" style="width: 60%; align-self: center;">
    </div>
    <div style="flex: 4; padding-right: 10px; display: flex; align-items: center;">
  ...
  margin-bottom: 10px; margin-top: 10px;">
    <div style="flex: 1; padding-right: 30px; display: flex; justify-content: center;">
      <img src="_static/images/feature-solid.png" alt="feature-solid" style="width: 60%; align-self: center;">
    </div>
    <div style="flex: 4; padding-right: 10px; display: flex; align-items: center;">
  ...
  margin-bottom: 10px; margin-top: 10px;">
    <div style="flex: 1; padding-right: 30px; display: flex; justify-content: center;">
      <img src="_static/images/feature-total.png" alt="feature-solid" style="width: 60%; align-self: center;">
    </div>
    <div style="flex: 4; padding-right: 10px; display: flex; align-items: center;">
...
You may install directly from GitHub, using the following command. This can be used to obtain the most recent version of ``jrystal``:
